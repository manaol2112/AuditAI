...
from appAUDITAI.models import (RequestIDCounter, ACCESSREQUESTCOMMENTS,UserToken,ACCESSREQUEST,APP_LIST,HR_JOB_PULL,HR_LIST_SFTP, PASSWORDPOLICY,ADMIN_ROLES_FILTER, APP_NEW_USER_APPROVAL,
