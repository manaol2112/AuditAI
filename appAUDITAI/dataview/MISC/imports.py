...
from appAUDITAI.models import (RISKMAPPING,CONTROLLIST, RISKRATING,RISKLIST,CONTROLS,RISKDETAILS,RISKGENERAL,WORKPAPER_UPLOAD,AUDITNOTES,AUDITFILE,RequestIDCounter, ACCESSREQUESTCOMMENTS,UserToken,ACCESSREQUEST,APP_LIST,HR_JOB_PULL,HR_LIST_SFTP, PASSWORDPOLICY,ADMIN_ROLES_FILTER, APP_NEW_USER_APPROVAL,
